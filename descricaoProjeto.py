...
#Descrição:
#Imagine que você trabalha em uma grande rede de lojas de rouipas com 25 lojas espalhadas por todo o Brasil.
#Todo dia, pela manhã, a equipe de analise de dados calcula os chamados One Pages e envia para o gerente de
#cada loja o OnePage da sua loja, bem como todas as informações usadas no cálculo dos indicadores.

#Um OnePage é um resumo muito simples e direto ao ponto, usado pela equipe de gerência de loja para saber os
# principais indicadores de cada loja e permitir em 1 página tanto a comparação entre diferentes lojas, quan
#to quais indicadores aquela loja conseguiu cumprir naquele dia ou não.

#Exemplo de one page:
#               Valor dia   Meta dia    Cenario dia
# - Indicador1      8           10           X
# - Indicador2      7            7           V
# - Indicador3      9            5           V

# O seu papel, como Analista de Dados, é conseguir criar um processo da forma mais automática possível para
# calcular o OnePage de cada loja e enviar um email para o gerente de cada loja com o seu OnePage no corpo
# do e-mail e também o arquivo completo com os dados da sua respectiva loja em anexo.
